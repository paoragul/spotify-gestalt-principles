...
class Album extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      album: this.props.navigation.getParam('title', 'Extraordinary Machine'),
      downloaded: false,
  ...
  componentDidMount() {
    ...
    this.setState({
      ...
      songData: {
        ...
        artist: albums[albumTitle]?.artist,
        image: albums[albumTitle]?.image,
        title: albums[albumTitle]?.title,
        text: albums[albumTitle]?.text
      }
    });
    console.log(this.props);
    //this.changeSong(this.state.songData);
  }
  ...
  render() {
    ...
    return (
      <Animated.ScrollView style={gStyle.container}>
        {toggleTabBarState ? (
        ...
        <View style={styles.containerFixed}>
          ...
          <View style={styles.containerImage}>
            <TouchableOpacity onPress={() => {window.open(images[album.image])}}>
          ...
          <View style={styles.containerAlbum}>
            <Text style={styles.albumInfo}>
              {(album.artist == 'Booba'  || album.artist =='Damso') ? `Single by ${album.artist} · ${album.released}`:
